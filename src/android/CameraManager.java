...
public final class CameraManager {
	...
	public void openDriver(int cameraType) throws IOException {
...
final class PreviewCallback implements Camera.PreviewCallback {
	...
	public void onPreviewFrame(byte[] data, Camera camera)
	{
		if (!newImageNeeded)
		{
			// Are we inactive since more than (5 seconds)600 miliseconds ??
			if (System.currentTimeMillis() - lastImageRequest > 550)
			{
				if (this.parentManager.previewing)
				{
